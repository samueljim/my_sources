<script context="module">
	export function preload({ params, query }) {
		return this.fetch(`tech.json`).then(r => r.json()).then(posts => {
			return { posts };
		});
	}
</script>
		  ...
		  <div class="breadcrumbs__items">
			 <div class="breadcrumbs__content">
				<div class="breadcrumbs__wrap">
				   ...
				   <div class="breadcrumbs__item"><span class="breadcrumbs__item-target">Tech</span></div>
				</div>
			 </div>
		  </div>
		  <div class="clear"></div>
		  ...
		  <div id="primary" class="col-xs-12 col-md-8">
			 <main id="main" class="site-main" role="main">
				<header class="page-header">
				   <h1 class="page-title screen-reader-text">Category: Tech</h1>
				</header>
				<!-- .page-header -->
				<h2 class="title-line archive-title">Tech</h2>
				   ...
				   <article class="posts-list__item card post-1849 post type-post status-publish format-standard has-post-thumbnail hentry category-science category-tech tag-tech has-thumb">
					  <div class="post-list__item-content">
						 <figure class="post-thumbnail post-thumbnail--ultra-small ">
							<a href="/tech/{post.slug}" class="post-thumbnail__link post-thumbnail--ultra-small"><img width="150" height="115" src="{post.image}" class="post-thumbnail__img wp-post-image" alt="{post.title}">				
							<div class="post__cats"><a href="/tech" rel="category tag">Tech</a></div>
						 </figure>
						 <!-- .post-thumbnail -->
						 <div class="post-body-right">
							<header class="entry-header">
							   <h5 class="entry-title"><a href="/tech/{post.slug}" rel="bookmark">{post.title || ''}</a></h5>
							</header>
							<!-- .entry-header -->
							...
							<div class="entry-meta-sharing">
							   <div class="entry-meta">
								  ...
								  <span class="post__date"><i class="material-icons">access_time</i><a class="post-date__link" href="/tech/{post.slug}">{post.date}</a></span><span class="post__comments"><i class="material-icons">chat_bubble_outline</i></span>					
							   </div>
							   <!-- .entry-meta -->
							...
							<footer class="entry-footer">
							   <a href="/tech" class="btn"><span class="btn__text">Read more</span><span class="btn__icon"></span></a>			
							   <div class="share-btns-main">
								  <i class="material-icons share-main-icon">share</i>
							   </div>
							</footer>
